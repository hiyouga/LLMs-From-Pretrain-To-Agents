...
\begin{itemize}
    ...
    \end{equation*}
    \item \textbf{High-quality data is the core of pre-training}
...
\begin{frame}
\frametitle{Our work: Easy Dataset (EMNLP'25, 13K GitHub Stars)}
...
\begin{frame}
\frametitle{Our work: DataFlow (arXiv'25, 2.8K GitHub Stars)}
...
\begin{frame}
\frametitle{Our work: LlamaFactory (ACL'24, 66K GitHub Stars)}
...
\begin{frame}
\frametitle{Our work: VeOmni (AAAI'26, 1.6K GitHub Stars)}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{images/efficient_training.png}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Our work: EasyR1 (4.5K GitHub Stars)}
